        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ url('/movie-filter') }}">
                            <div class="row">
                                <div class="col-lg-3">
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-sm-3">
                                                            <input type="number" name="priceMin" min="0"
                                                                value="{{ request('priceMin') ? request('priceMin') : '0' }}"
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="number" name="priceMax" min="0"
                                                                value="{{ request('priceMax') ? request('priceMax') : '10000' }}"
                                                                class="form-control" required />
                                                        </div>
                                                    </div>
                                                    <br />
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        value="{{ $c->id }}"
                                                                        name="category_ids[]"
                                                                        {{ in_array($loop->iteration, request('category_ids', [])) ? 'checked' : '' }}>
